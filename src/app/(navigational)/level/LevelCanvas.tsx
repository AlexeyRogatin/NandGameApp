...
import { Level } from "@/app/lib/scheme/levels";
import { useEffect, useRef } from "react";
import { DropBox, Scheme } from "../../lib/scheme/Components";
import Mouse from "../../lib/scheme/Mouse";
import Keyboard from "@/app/lib/scheme/Keyboard";
...
export default function LevelCanvas({level, setScheme}: {level: Level, setScheme: (s: Scheme) => void}) {
    ...
    useEffect(() => {
        ...
        const loop = keyboard.makeKeyboardUpdateable(mouse.makeMouseUpdateable(() => {
            ...
            //drag cycle
            scheme.handleDrag(mouse, SIZE, DROP_BOX_SIZE, HOR_COUNT, 0, VER_COUNT);
